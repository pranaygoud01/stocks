...
class Meta extends Component {
  ...
  fetchStock() {
    ...
    let API_CALL = `https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=META&outputsize=compact&apikey=${API_KEY}`;
    let stockXfunction = [];
    let stockYfunction = [];
    fetch(API_CALL)
      ...
      <div>
        <div>
          <Plot
            ...
            layout={{ width: 500, height: 500, title: "META Stocks" }}
          />
        </div>
      </div>
    );
